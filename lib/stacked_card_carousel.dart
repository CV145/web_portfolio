...
class StackedCardCarouselState extends State<StackedCardCarousel> {
  ...
  Widget _stackedCards(BuildContext context) {
    ...
    //Mapping the list of widgets (figuring out where to position them)
    final List<Widget> positionedCards = widget._items.asMap().entries.map(
        ...
        //Cards are positioned differently depending on case
        switch (widget._type) {
          case StackedCardCarouselType.fadeOutStack:
            ...
            //Returning positioned card (left, right, top, bottom)
